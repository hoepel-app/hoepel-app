import { GraphQLSchema, DirectiveNode, GraphQLNamedType } from 'graphql'
import { IndexedByTenantCollection, Collection, DocPerTenantCollection, DocPerUserCollection } from './collection'
import { schema } from './schema'

const firestoreCollectionsToCreate = (schema: GraphQLSchema): readonly Collection[] => {
...
firestoreCollectionsToCreate(schema).forEach(coll => console.log(coll.firestoreRules + '\n'))
