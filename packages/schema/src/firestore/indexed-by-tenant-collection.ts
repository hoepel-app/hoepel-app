...
export class IndexedByTenantCollection extends Collection {
    ...
    get firestoreRules() {
        ...
        if (this.allowPublicRead) {
            ...
            allowRead = createRuleLine(this.permissions.readPermission, 'resource.data.tenant')
        }
        ...
        return [
            new Rule({
                ...
                allowRead,
                allowCreate: createRuleLine(this.permissions.writePermission, 'request.resource.data.tenant'),
                allowUpdate: createRuleLine(this.permissions.updatePermission, 'resource.data.tenant'),
                allowDelete: createRuleLine(this.permissions.deletePermission, 'resource.data.tenant'),
            }),
